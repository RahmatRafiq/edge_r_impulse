 ...
 */
// Generated on: 09.08.2024 07:21:40
...
const TfArray<1, float> quant0_scale = { 1, { 133.86666870117188, } };
const TfArray<1, int> quant0_zero = { 1, { -46 } };
const TfLiteAffineQuantization quant0 = { (TfLiteFloatArray*)&quant0_scale, (TfLiteIntArray*)&quant0_zero, 0 };
const ALIGN(4) int32_t tensor_data1[1] = { 0, };
const TfArray<1, int> tensor_dimension1 = { 1, { 1 } };
const TfArray<1, float> quant1_scale = { 1, { 0.19507016241550446, } };
const TfArray<1, int> quant1_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant1 = { (TfLiteFloatArray*)&quant1_scale, (TfLiteIntArray*)&quant1_zero, 0 };
const ALIGN(8) int8_t tensor_data2[1*10] = { 
  75, 63, -111, 8, 73, -28, 105, -29, 127, -108, 
};
const TfArray<2, int> tensor_dimension2 = { 2, { 1,10 } };
const TfArray<1, float> quant2_scale = { 1, { 0.0053389929234981537, } };
...
const TfArray<1, float> quant3_scale = { 1, { 0.12350048124790192, } };
const TfArray<1, int> quant3_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant3 = { (TfLiteFloatArray*)&quant3_scale, (TfLiteIntArray*)&quant3_zero, 0 };
const ALIGN(16) int8_t tensor_data4[10*20] = { 
  36, -82, -79, 7, 106, 17, 113, -111, -6, -61, 25, 20, 67, 113, 50, -95, -7, -28, -75, 26, 
  -73, -121, 57, 55, 57, -43, -69, -102, -98, 4, -56, -56, 67, 9, 58, 80, -67, 36, -47, -33, 
  -24, -102, -3, 112, -51, -63, -38, 22, -43, -12, 34, 54, -23, -91, -14, -74, 89, -103, -106, -86, 
  46, 4, 83, -13, -82, 70, -79, -57, -39, 61, 95, 41, -75, -117, -21, -64, -45, -67, 103, 85, 
  -48, 55, -102, -45, -100, 64, -38, 23, -104, 65, 87, 53, -17, 52, 26, -101, -52, 99, 70, 60, 
  -93, 80, -74, 54, -24, -115, -7, 86, -119, -50, 88, 69, -60, 66, -25, -72, -39, 71, -68, 3, 
  97, 42, -62, -83, 75, 73, 12, -41, -34, 3, 58, 36, -71, -43, 10, -19, 63, -26, -23, -37, 
  -3, 102, 64, 80, -4, 100, 106, -114, 125, -17, -56, 125, 64, -14, -90, 68, 104, 11, 18, 87, 
  55, 35, 46, 32, 83, 25, -127, -33, -38, 1, 92, 15, 0, -123, -48, 90, -104, 68, -56, -35, 
  47, -69, -17, -2, 94, 116, -21, 16, 87, -99, -56, 58, -85, -57, 59, -20, -20, 101, 8, 81, 
};
const TfArray<2, int> tensor_dimension4 = { 2, { 10,20 } };
const TfArray<1, float> quant4_scale = { 1, { 0.0036125699989497662, } };
...
const TfArray<1, float> quant5_scale = { 1, { 0.54508823156356812, } };
const TfArray<1, int> quant5_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant5 = { (TfLiteFloatArray*)&quant5_scale, (TfLiteIntArray*)&quant5_zero, 0 };
const ALIGN(16) int8_t tensor_data6[20*3] = { 
  -29, -46, -20, 
  -127, -14, 92, 
  71, -25, -93, 
  -112, 56, -52, 
...
const TfArray<1, float> quant6_scale = { 1, { 0.0040718740783631802, } };
const TfArray<1, int> quant6_zero = { 1, { 0 } };
const TfLiteAffineQuantization quant6 = { (TfLiteFloatArray*)&quant6_scale, (TfLiteIntArray*)&quant6_zero, 0 };
const TfArray<2, int> tensor_dimension7 = { 2, { 1,20 } };
const TfArray<1, float> quant7_scale = { 1, { 34.186321258544922, } };
const TfArray<1, int> quant7_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant7 = { (TfLiteFloatArray*)&quant7_scale, (TfLiteIntArray*)&quant7_zero, 0 };
const TfArray<2, int> tensor_dimension8 = { 2, { 1,10 } };
const TfArray<1, float> quant8_scale = { 1, { 36.536884307861328, } };
const TfArray<1, int> quant8_zero = { 1, { -128 } };
const TfLiteAffineQuantization quant8 = { (TfLiteFloatArray*)&quant8_scale, (TfLiteIntArray*)&quant8_zero, 0 };
const TfArray<2, int> tensor_dimension9 = { 2, { 1,1 } };
const TfArray<1, float> quant9_scale = { 1, { 0.070154286921024323, } };
